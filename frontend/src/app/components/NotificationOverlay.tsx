        ...
        <>
            ...
            <div className="fixed bottom-8 right-8 z-[9999] flex flex-col gap-4 max-w-md w-full sm:w-auto">
                {toasts.map((toast) => (
                    <div 
                        key={toast.id}
                        className={`group relative flex items-center gap-4 p-5 rounded-2xl border bg-[#111] shadow-2xl animate-in slide-in-from-right-full fade-in duration-500 hover:scale-[1.02] transition-all cursor-pointer ${
                            toast.type === 'success' ? 'border-[#99cc00]/20 text-[#99cc00]' :
                            toast.type === 'error' ? 'border-[#BF1737]/20 text-[#BF1737]' :
                    ...
                    >
                        ...
                        <div className={`h-10 w-10 rounded-full flex items-center justify-center shrink-0 shadow-lg ${
                            toast.type === 'success' ? 'bg-[#99cc00] text-black shadow-[#99cc00]/20' :
            ...
            {activeConfirm && (
                <div className="fixed inset-0 z-[10000] flex items-center justify-center p-6 animate-in fade-in duration-300 backdrop-blur-md bg-black/40">
                    <div className="bg-[#111] rounded-[32px] w-full max-w-md overflow-hidden shadow-2xl border border-white/10 animate-in zoom-in-95 slide-in-from-bottom-8 duration-500">
                        {/* Modal Header/Icon */}
                        ...
                        <div className="p-10 text-center">
                            ...
                            <div className="flex flex-col sm:flex-row gap-4 items-stretch sm:items-center">
                                ...
                                <button 
                                    ...
                                    className="flex-1 rounded-2xl bg-white/5 py-4.5 text-[13px] font-black text-white/40 uppercase tracking-[0.2em] transition-all hover:bg-white/10 hover:text-white"
                                >
